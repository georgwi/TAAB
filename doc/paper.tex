...
\begin{figure}[h!]
	\centering
	\subfloat[Without second direction]{\includegraphics[scale=0.5]{images/mainvec.jpg}} \hspace*{1cm}
	\subfloat[With second direction]{\includegraphics[scale=0.5]{images/secvec.jpg}}
...
\begin{figure}[h!]
	\centering
	\subfloat{\includegraphics[scale=0.4]{images/view_small.jpg}}
	\hspace{1cm}
	\subfloat{\includegraphics[scale=0.4]{images/view_medium.jpg}}
	\\
	\subfloat{\includegraphics[scale=0.6]{images/view_large.jpg}}
...
\begin{figure}
	\centering
	\subfloat[Map with local vectors]{\includegraphics[scale=0.4]{images/map2_withlocal.jpg}}
	\subfloat[]{\includegraphics[scale=0.35]{images/pi.jpg}}
\end{figure}
